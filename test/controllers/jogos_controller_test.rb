...
class JogosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create jogo" do
    assert_difference('Jogo.count') do
      post jogos_url, params: { jogo: { descricao: @jogo.descricao, desenvolvedora: @jogo.desenvolvedora, lancamento: @jogo.lancamento, titulo: @jogo.titulo } }
    end
  ...
  test "should update jogo" do
    patch jogo_url(@jogo), params: { jogo: { descricao: @jogo.descricao, desenvolvedora: @jogo.desenvolvedora, lancamento: @jogo.lancamento, titulo: @jogo.titulo } }
